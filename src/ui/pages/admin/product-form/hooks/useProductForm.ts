...
export function useProductForm(id?: string) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const data = {
      ...
      imageUrl: form.imageUrl || (form.media[0]?.url) || '/assets/generated/generic_tcg_strategy_1778177431609.png',
      media: form.media,
      status: form.status,
  ...
  async function handleDuplicate() {
    try {
      ...
      const data = {
        ...
        imageUrl: copyData.imageUrl || (copyData.media[0]?.url) || '/assets/generated/generic_tcg_strategy_1778177431609.png',
